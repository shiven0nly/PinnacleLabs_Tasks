  ...
  return (
    ...
    <div className='grid grid-cols-2 gap-4'>
      ...
      <div className='flex flex-col justify-center items-center h-screen border-r border-border bg-amber-200'>
        ...
        <p className='text-2xl font-semibold flex justify-start ml-10'>Welcome, create your account</p>
        <p className="flex justify-start items-center text-xl font-mono mt-3 text-muted-foreground">Read the latest news from around the world</p>
        </div>
      </div>
      {/* right side */}
