      ...
      <div className="card-body p-5">
        <div className="row align-items-center">
          <div className="col-md-7 text-center text-md-start mb-4 mb-md-0">
            <h2 className="display-4 fw-bold mb-1 text-white">
              {current.cityName}
            </h2>
            <p className="fs-4 text-muted-light text-capitalize mb-4">
              {current.description}
            </p>
            <h1
        ...
        <div className="row text-center mt-4 pb-2">
          <div className="col-4 border-end border-light border-opacity-25">
            <h6
              className="text-muted-light mb-2 text-uppercase"
              style={{ letterSpacing: '1px' }}
            >
              Feels Like
            </h6>
            <p className="fs-3 fw-semibold mb-0 text-white">
          ...
          <div className="col-4">
            ...
            <p className="fs-3 fw-semibold mb-0 text-white">
              {current.windSpeed}{' '}
              <span className="fs-6 fw-normal text-muted-light">m/s</span>
            </p>
          </div>
        </div>
      </div>
