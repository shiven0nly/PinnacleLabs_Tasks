          ...
          return (
            <div className="col" key={index}>
              <div className="card glass-card border-0 text-center p-4 h-100 transition-hover">
                <p className="mb-2 fw-semibold fs-5 text-white">
                  {date.split(' ')[0]}
                </p>
                <small className="text-muted-light d-block mb-3">
                ...
                />
                <h3 className="fw-bold mt-2 mb-1 text-white">
                  {Math.round(day.main.temp)}°
                </h3>
                <small className="text-muted-light text-capitalize d-block mt-2">
                  {day.weather[0].main}
                </small>
              </div>
            </div>
